...
class SS:
    def __init__(self, start=None, end=None, calender_path=None, factor_path=None, daily_path=None,st_path=None,
        ...
        self.factor_path=r'\\192.168.1.210\Factor_Storage\田逸心\原始数据\拟使用量价因子' or factor_path
        self.daily_path = daily_path or r'Z:\local_data\Data_Storage\daily.feather'
        self.train_ratio=train_ratio
        self.vaild_ratio=valid_ratio
        self.calender_path = calender_path or r'\\192.168.1.210\Data_Storage2\calendar.csv'
        # y数据---------------------------------------------
        ...
        # ----------------------------------------------------
        self.st_path=st_path or r'Z:\local_data\base_data\st.csv'
