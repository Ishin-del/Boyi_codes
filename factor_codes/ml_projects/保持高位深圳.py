...
def ml_para():
    ...
    # model = XGBRegressor(n_estimators=500, max_depth=4, learning_rate=0.01, subsample=0.8, colsample_bytree=0.8,
...
def ml(file_name):
    ...
    joblib.dump(grid_search, os.path.join(path,'lgb.joblib'))
    print('保存成功')
