...
def ml_para():
    # model = lgb.LGBMRegressor(n_estimators=150, learning_rate=0.01, max_depth=2, num_leaves=50, min_child_samples=30,
    ...
    # model=linear_model.ElasticNet(alpha=0.1, l1_ratio=0.5)#alpha=0.1, l1_ratio=0.5
    # model=linear_model.Lasso(alpha=0.1)#alpha=0.1, l1_ratio=0.5
    model=linear_model.Ridge(alpha=0.1)#alpha=0.1, l1_ratio=0.5
...
def ml(file_name):
    ...
    joblib.dump(grid_search, os.path.join(path,'ridge.joblib'))
